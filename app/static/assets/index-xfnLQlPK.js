(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function s(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(i){if(i.ep)return;i.ep=!0;const n=s(i);fetch(i.href,n)}})();const Dt=globalThis,Bt=Dt.ShadowRoot&&(Dt.ShadyCSS===void 0||Dt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ht=Symbol(),te=new WeakMap;let be=class{constructor(e,s,a){if(this._$cssResult$=!0,a!==Ht)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=s}get styleSheet(){let e=this.o;const s=this.t;if(Bt&&e===void 0){const a=s!==void 0&&s.length===1;a&&(e=te.get(s)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),a&&te.set(s,e))}return e}toString(){return this.cssText}};const De=t=>new be(typeof t=="string"?t:t+"",void 0,Ht),Oe=(t,...e)=>{const s=t.length===1?t[0]:e.reduce((a,i,n)=>a+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[n+1],t[0]);return new be(s,t,Ht)},Me=(t,e)=>{if(Bt)t.adoptedStyleSheets=e.map(s=>s instanceof CSSStyleSheet?s:s.styleSheet);else for(const s of e){const a=document.createElement("style"),i=Dt.litNonce;i!==void 0&&a.setAttribute("nonce",i),a.textContent=s.cssText,t.appendChild(a)}},ee=Bt?t=>t:t=>t instanceof CSSStyleSheet?(e=>{let s="";for(const a of e.cssRules)s+=a.cssText;return De(s)})(t):t;const{is:je,defineProperty:Ne,getOwnPropertyDescriptor:Re,getOwnPropertyNames:Le,getOwnPropertySymbols:ze,getPrototypeOf:Ue}=Object,Nt=globalThis,se=Nt.trustedTypes,Be=se?se.emptyScript:"",He=Nt.reactiveElementPolyfillSupport,xt=(t,e)=>t,Ot={toAttribute(t,e){switch(e){case Boolean:t=t?Be:null;break;case Object:case Array:t=t==null?t:JSON.stringify(t)}return t},fromAttribute(t,e){let s=t;switch(e){case Boolean:s=t!==null;break;case Number:s=t===null?null:Number(t);break;case Object:case Array:try{s=JSON.parse(t)}catch{s=null}}return s}},Kt=(t,e)=>!je(t,e),ie={attribute:!0,type:String,converter:Ot,reflect:!1,useDefault:!1,hasChanged:Kt};Symbol.metadata??=Symbol("metadata"),Nt.litPropertyMetadata??=new WeakMap;let ht=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,s=ie){if(s.state&&(s.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((s=Object.create(s)).wrapped=!0),this.elementProperties.set(e,s),!s.noAccessor){const a=Symbol(),i=this.getPropertyDescriptor(e,a,s);i!==void 0&&Ne(this.prototype,e,i)}}static getPropertyDescriptor(e,s,a){const{get:i,set:n}=Re(this.prototype,e)??{get(){return this[s]},set(o){this[s]=o}};return{get:i,set(o){const h=i?.call(this);n?.call(this,o),this.requestUpdate(e,h,a)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??ie}static _$Ei(){if(this.hasOwnProperty(xt("elementProperties")))return;const e=Ue(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(xt("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(xt("properties"))){const s=this.properties,a=[...Le(s),...ze(s)];for(const i of a)this.createProperty(i,s[i])}const e=this[Symbol.metadata];if(e!==null){const s=litPropertyMetadata.get(e);if(s!==void 0)for(const[a,i]of s)this.elementProperties.set(a,i)}this._$Eh=new Map;for(const[s,a]of this.elementProperties){const i=this._$Eu(s,a);i!==void 0&&this._$Eh.set(i,s)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const s=[];if(Array.isArray(e)){const a=new Set(e.flat(1/0).reverse());for(const i of a)s.unshift(ee(i))}else e!==void 0&&s.push(ee(e));return s}static _$Eu(e,s){const a=s.attribute;return a===!1?void 0:typeof a=="string"?a:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){const e=new Map,s=this.constructor.elementProperties;for(const a of s.keys())this.hasOwnProperty(a)&&(e.set(a,this[a]),delete this[a]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Me(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,s,a){this._$AK(e,a)}_$ET(e,s){const a=this.constructor.elementProperties.get(e),i=this.constructor._$Eu(e,a);if(i!==void 0&&a.reflect===!0){const n=(a.converter?.toAttribute!==void 0?a.converter:Ot).toAttribute(s,a.type);this._$Em=e,n==null?this.removeAttribute(i):this.setAttribute(i,n),this._$Em=null}}_$AK(e,s){const a=this.constructor,i=a._$Eh.get(e);if(i!==void 0&&this._$Em!==i){const n=a.getPropertyOptions(i),o=typeof n.converter=="function"?{fromAttribute:n.converter}:n.converter?.fromAttribute!==void 0?n.converter:Ot;this._$Em=i;const h=o.fromAttribute(s,n.type);this[i]=h??this._$Ej?.get(i)??h,this._$Em=null}}requestUpdate(e,s,a,i=!1,n){if(e!==void 0){const o=this.constructor;if(i===!1&&(n=this[e]),a??=o.getPropertyOptions(e),!((a.hasChanged??Kt)(n,s)||a.useDefault&&a.reflect&&n===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,a))))return;this.C(e,s,a)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,s,{useDefault:a,reflect:i,wrapped:n},o){a&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??s??this[e]),n!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||a||(s=void 0),this._$AL.set(e,s)),i===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(s){Promise.reject(s)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[i,n]of this._$Ep)this[i]=n;this._$Ep=void 0}const a=this.constructor.elementProperties;if(a.size>0)for(const[i,n]of a){const{wrapped:o}=n,h=this[i];o!==!0||this._$AL.has(i)||h===void 0||this.C(i,void 0,n,h)}}let e=!1;const s=this._$AL;try{e=this.shouldUpdate(s),e?(this.willUpdate(s),this._$EO?.forEach(a=>a.hostUpdate?.()),this.update(s)):this._$EM()}catch(a){throw e=!1,this._$EM(),a}e&&this._$AE(s)}willUpdate(e){}_$AE(e){this._$EO?.forEach(s=>s.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(s=>this._$ET(s,this[s])),this._$EM()}updated(e){}firstUpdated(e){}};ht.elementStyles=[],ht.shadowRootOptions={mode:"open"},ht[xt("elementProperties")]=new Map,ht[xt("finalized")]=new Map,He?.({ReactiveElement:ht}),(Nt.reactiveElementVersions??=[]).push("2.1.2");const Wt=globalThis,ae=t=>t,Mt=Wt.trustedTypes,re=Mt?Mt.createPolicy("lit-html",{createHTML:t=>t}):void 0,$e="$lit$",q=`lit$${Math.random().toFixed(9).slice(2)}$`,we="?"+q,Ke=`<${we}>`,it=document,_t=()=>it.createComment(""),Ct=t=>t===null||typeof t!="object"&&typeof t!="function",Jt=Array.isArray,We=t=>Jt(t)||typeof t?.[Symbol.iterator]=="function",Lt=`[ 	
\f\r]`,$t=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ne=/-->/g,oe=/>/g,et=RegExp(`>|${Lt}(?:([^\\s"'>=/]+)(${Lt}*=${Lt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),le=/'/g,de=/"/g,xe=/^(?:script|style|textarea|title)$/i,Je=t=>(e,...s)=>({_$litType$:t,strings:e,values:s}),r=Je(1),gt=Symbol.for("lit-noChange"),x=Symbol.for("lit-nothing"),ce=new WeakMap,st=it.createTreeWalker(it,129);function ke(t,e){if(!Jt(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return re!==void 0?re.createHTML(e):e}const Fe=(t,e)=>{const s=t.length-1,a=[];let i,n=e===2?"<svg>":e===3?"<math>":"",o=$t;for(let h=0;h<s;h++){const c=t[h];let f,p,d=-1,b=0;for(;b<c.length&&(o.lastIndex=b,p=o.exec(c),p!==null);)b=o.lastIndex,o===$t?p[1]==="!--"?o=ne:p[1]!==void 0?o=oe:p[2]!==void 0?(xe.test(p[2])&&(i=RegExp("</"+p[2],"g")),o=et):p[3]!==void 0&&(o=et):o===et?p[0]===">"?(o=i??$t,d=-1):p[1]===void 0?d=-2:(d=o.lastIndex-p[2].length,f=p[1],o=p[3]===void 0?et:p[3]==='"'?de:le):o===de||o===le?o=et:o===ne||o===oe?o=$t:(o=et,i=void 0);const $=o===et&&t[h+1].startsWith("/>")?" ":"";n+=o===$t?c+Ke:d>=0?(a.push(f),c.slice(0,d)+$e+c.slice(d)+q+$):c+q+(d===-2?h:$)}return[ke(t,n+(t[s]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),a]};class St{constructor({strings:e,_$litType$:s},a){let i;this.parts=[];let n=0,o=0;const h=e.length-1,c=this.parts,[f,p]=Fe(e,s);if(this.el=St.createElement(f,a),st.currentNode=this.el.content,s===2||s===3){const d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(i=st.nextNode())!==null&&c.length<h;){if(i.nodeType===1){if(i.hasAttributes())for(const d of i.getAttributeNames())if(d.endsWith($e)){const b=p[o++],$=i.getAttribute(d).split(q),C=/([.?@])?(.*)/.exec(b);c.push({type:1,index:n,name:C[2],strings:$,ctor:C[1]==="."?qe:C[1]==="?"?Ye:C[1]==="@"?Ge:Rt}),i.removeAttribute(d)}else d.startsWith(q)&&(c.push({type:6,index:n}),i.removeAttribute(d));if(xe.test(i.tagName)){const d=i.textContent.split(q),b=d.length-1;if(b>0){i.textContent=Mt?Mt.emptyScript:"";for(let $=0;$<b;$++)i.append(d[$],_t()),st.nextNode(),c.push({type:2,index:++n});i.append(d[b],_t())}}}else if(i.nodeType===8)if(i.data===we)c.push({type:2,index:n});else{let d=-1;for(;(d=i.data.indexOf(q,d+1))!==-1;)c.push({type:7,index:n}),d+=q.length-1}n++}}static createElement(e,s){const a=it.createElement("template");return a.innerHTML=e,a}}function mt(t,e,s=t,a){if(e===gt)return e;let i=a!==void 0?s._$Co?.[a]:s._$Cl;const n=Ct(e)?void 0:e._$litDirective$;return i?.constructor!==n&&(i?._$AO?.(!1),n===void 0?i=void 0:(i=new n(t),i._$AT(t,s,a)),a!==void 0?(s._$Co??=[])[a]=i:s._$Cl=i),i!==void 0&&(e=mt(t,i._$AS(t,e.values),i,a)),e}class Ve{constructor(e,s){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=s}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:s},parts:a}=this._$AD,i=(e?.creationScope??it).importNode(s,!0);st.currentNode=i;let n=st.nextNode(),o=0,h=0,c=a[0];for(;c!==void 0;){if(o===c.index){let f;c.type===2?f=new At(n,n.nextSibling,this,e):c.type===1?f=new c.ctor(n,c.name,c.strings,this,e):c.type===6&&(f=new Ze(n,this,e)),this._$AV.push(f),c=a[++h]}o!==c?.index&&(n=st.nextNode(),o++)}return st.currentNode=it,i}p(e){let s=0;for(const a of this._$AV)a!==void 0&&(a.strings!==void 0?(a._$AI(e,a,s),s+=a.strings.length-2):a._$AI(e[s])),s++}}class At{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,s,a,i){this.type=2,this._$AH=x,this._$AN=void 0,this._$AA=e,this._$AB=s,this._$AM=a,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const s=this._$AM;return s!==void 0&&e?.nodeType===11&&(e=s.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,s=this){e=mt(this,e,s),Ct(e)?e===x||e==null||e===""?(this._$AH!==x&&this._$AR(),this._$AH=x):e!==this._$AH&&e!==gt&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):We(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==x&&Ct(this._$AH)?this._$AA.nextSibling.data=e:this.T(it.createTextNode(e)),this._$AH=e}$(e){const{values:s,_$litType$:a}=e,i=typeof a=="number"?this._$AC(e):(a.el===void 0&&(a.el=St.createElement(ke(a.h,a.h[0]),this.options)),a);if(this._$AH?._$AD===i)this._$AH.p(s);else{const n=new Ve(i,this),o=n.u(this.options);n.p(s),this.T(o),this._$AH=n}}_$AC(e){let s=ce.get(e.strings);return s===void 0&&ce.set(e.strings,s=new St(e)),s}k(e){Jt(this._$AH)||(this._$AH=[],this._$AR());const s=this._$AH;let a,i=0;for(const n of e)i===s.length?s.push(a=new At(this.O(_t()),this.O(_t()),this,this.options)):a=s[i],a._$AI(n),i++;i<s.length&&(this._$AR(a&&a._$AB.nextSibling,i),s.length=i)}_$AR(e=this._$AA.nextSibling,s){for(this._$AP?.(!1,!0,s);e!==this._$AB;){const a=ae(e).nextSibling;ae(e).remove(),e=a}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}}class Rt{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,s,a,i,n){this.type=1,this._$AH=x,this._$AN=void 0,this.element=e,this.name=s,this._$AM=i,this.options=n,a.length>2||a[0]!==""||a[1]!==""?(this._$AH=Array(a.length-1).fill(new String),this.strings=a):this._$AH=x}_$AI(e,s=this,a,i){const n=this.strings;let o=!1;if(n===void 0)e=mt(this,e,s,0),o=!Ct(e)||e!==this._$AH&&e!==gt,o&&(this._$AH=e);else{const h=e;let c,f;for(e=n[0],c=0;c<n.length-1;c++)f=mt(this,h[a+c],s,c),f===gt&&(f=this._$AH[c]),o||=!Ct(f)||f!==this._$AH[c],f===x?e=x:e!==x&&(e+=(f??"")+n[c+1]),this._$AH[c]=f}o&&!i&&this.j(e)}j(e){e===x?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class qe extends Rt{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===x?void 0:e}}class Ye extends Rt{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==x)}}class Ge extends Rt{constructor(e,s,a,i,n){super(e,s,a,i,n),this.type=5}_$AI(e,s=this){if((e=mt(this,e,s,0)??x)===gt)return;const a=this._$AH,i=e===x&&a!==x||e.capture!==a.capture||e.once!==a.once||e.passive!==a.passive,n=e!==x&&(a===x||i);i&&this.element.removeEventListener(this.name,this,a),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class Ze{constructor(e,s,a){this.element=e,this.type=6,this._$AN=void 0,this._$AM=s,this.options=a}get _$AU(){return this._$AM._$AU}_$AI(e){mt(this,e)}}const Xe=Wt.litHtmlPolyfillSupport;Xe?.(St,At),(Wt.litHtmlVersions??=[]).push("3.3.2");const Qe=(t,e,s)=>{const a=s?.renderBefore??e;let i=a._$litPart$;if(i===void 0){const n=s?.renderBefore??null;a._$litPart$=i=new At(e.insertBefore(_t(),n),n,void 0,s??{})}return i._$AI(t),i};const Ft=globalThis;class g extends ht{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const s=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Qe(s,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return gt}}g._$litElement$=!0,g.finalized=!0,Ft.litElementHydrateSupport?.({LitElement:g});const ts=Ft.litElementPolyfillSupport;ts?.({LitElement:g});(Ft.litElementVersions??=[]).push("4.2.2");const w=t=>(e,s)=>{s!==void 0?s.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)};const es={attribute:!0,type:String,converter:Ot,reflect:!1,hasChanged:Kt},ss=(t=es,e,s)=>{const{kind:a,metadata:i}=s;let n=globalThis.litPropertyMetadata.get(i);if(n===void 0&&globalThis.litPropertyMetadata.set(i,n=new Map),a==="setter"&&((t=Object.create(t)).wrapped=!0),n.set(s.name,t),a==="accessor"){const{name:o}=s;return{set(h){const c=e.get.call(this);e.set.call(this,h),this.requestUpdate(o,c,t,!0,h)},init(h){return h!==void 0&&this.C(o,void 0,t,h),h}}}if(a==="setter"){const{name:o}=s;return function(h){const c=this[o];e.call(this,h),this.requestUpdate(o,c,t,!0,h)}}throw Error("Unsupported decorator location: "+a)};function u(t){return(e,s)=>typeof s=="object"?ss(t,e,s):((a,i,n)=>{const o=i.hasOwnProperty(n);return i.constructor.createProperty(n,a),o?Object.getOwnPropertyDescriptor(i,n):void 0})(t,e,s)}function l(t){return u({...t,state:!0,attribute:!1})}const _e=(typeof window<"u"&&window.API_URL)??"https://api.coderclaw.ai",Vt="ccl-web-token",qt="ccl-tenant-token",Yt="ccl-tenant-id",Gt="ccl-user";function Zt(){return localStorage.getItem(Vt)}function L(){return localStorage.getItem(qt)}function Ce(){return localStorage.getItem(Yt)}function Se(t){localStorage.setItem(Vt,t)}function zt(t){localStorage.setItem(qt,t)}function Ut(t){localStorage.setItem(Yt,t)}function Ae(t){localStorage.setItem(Gt,JSON.stringify(t))}function Te(){const t=localStorage.getItem(Gt);return t?JSON.parse(t):null}function jt(){localStorage.removeItem(Vt),localStorage.removeItem(qt),localStorage.removeItem(Yt),localStorage.removeItem(Gt)}class Ee extends Error{constructor(e,s){super(s),this.status=e}}async function v(t,e={}){const{token:s,...a}=e,i=s??L()??Zt(),n=new Headers(a.headers);n.set("Content-Type","application/json"),i&&n.set("Authorization",`Bearer ${i}`);const o=await fetch(`${_e}${t}`,{...a,headers:n});if(o.status===401&&(jt(),window.dispatchEvent(new CustomEvent("ccl:unauthorized"))),!o.ok){let h=o.statusText;try{const c=await o.json();h=c.error??c.message??h}catch{}throw new Ee(o.status,h)}if(o.status!==204)return o.json()}const Y={async register(t,e){return v("/api/auth/web/register",{method:"POST",body:JSON.stringify({email:t,password:e}),token:null})},async login(t,e){return v("/api/auth/web/login",{method:"POST",body:JSON.stringify({email:t,password:e}),token:null})},async tenantToken(t){return v("/api/auth/tenant-token",{method:"POST",body:JSON.stringify({tenantId:t})})},async listTenants(){return v("/api/tenants")}},kt={async create(t){return v("/api/tenants",{method:"POST",body:JSON.stringify({name:t})})},async get(t){return v(`/api/tenants/${t}`)},async inviteMember(t,e,s){return v(`/api/tenants/${t}/members`,{method:"POST",body:JSON.stringify({email:e,role:s})})},async removeMember(t,e){return v(`/api/tenants/${t}/members/${e}`,{method:"DELETE"})}},pt={async list(){return v("/api/projects")},async create(t){return v("/api/projects",{method:"POST",body:JSON.stringify(t)})},async update(t,e){return v(`/api/projects/${t}`,{method:"PATCH",body:JSON.stringify(e)})},async remove(t){return v(`/api/projects/${t}`,{method:"DELETE"})}},P={async list(t){const e=new URLSearchParams;return t?.projectId&&e.set("projectId",t.projectId),t?.status&&e.set("status",t.status),t?.archived&&e.set("archived","true"),v(`/api/tasks${e.size?`?${e}`:""}`)},async create(t){return v("/api/tasks",{method:"POST",body:JSON.stringify(t)})},async update(t,e){return v(`/api/tasks/${t}`,{method:"PATCH",body:JSON.stringify(e)})},async remove(t){return v(`/api/tasks/${t}`,{method:"DELETE"})},async run(t,e){return v(`/api/tasks/${t}/executions`,{method:"POST",body:JSON.stringify({payload:e})})},async executions(t){return v(`/api/tasks/${t}/executions`)}},ut={async list(){return v("/api/claws")},async register(t){return v("/api/claws",{method:"POST",body:JSON.stringify({name:t})})},async remove(t){return v(`/api/claws/${t}`,{method:"DELETE"})},async status(t){return v(`/api/claws/${t}/status`)},wsUrl(t){const e=_e.replace(/^http/,"ws"),s=L()??"";return`${e}/api/claws/${t}/ws?token=${encodeURIComponent(s)}`}},Xt={async list(){return v("/marketplace/skills")}},vt={async listTenant(){return v("/api/skill-assignments/tenant")},async assignTenant(t){return v("/api/skill-assignments/tenant",{method:"POST",body:JSON.stringify({slug:t})})},async unassignTenant(t){return v(`/api/skill-assignments/tenant/${t}`,{method:"DELETE"})},async assignClaw(t,e){return v(`/api/skill-assignments/claws/${t}`,{method:"POST",body:JSON.stringify({slug:e})})}},Qt={async list(t){const e=new URLSearchParams;return t?.taskId&&e.set("taskId",t.taskId),t?.clawId&&e.set("clawId",t.clawId),v(`/api/executions${e.size?`?${e}`:""}`)}},he=Object.freeze(Object.defineProperty({__proto__:null,ApiError:Ee,auth:Y,claws:ut,clearSession:jt,executions:Qt,getTenantId:Ce,getTenantToken:L,getUser:Te,getWebToken:Zt,marketplace:Xt,projects:pt,setTenantId:Ut,setTenantToken:zt,setUser:Ae,setWebToken:Se,skillAssignments:vt,tasks:P,tenants:kt},Symbol.toStringTag,{value:"Module"}));var is=Object.defineProperty,as=Object.getOwnPropertyDescriptor,yt=(t,e,s,a)=>{for(var i=a>1?void 0:a?as(e,s):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(i=(a?o(e,s,i):o(i))||i);return a&&i&&is(e,s,i),i};let at=class extends g{constructor(){super(...arguments),this.mode="login",this.email="",this.password="",this.loading=!1,this.error=""}createRenderRoot(){return this}async submit(t){if(t.preventDefault(),!(!this.email||!this.password)){this.loading=!0,this.error="";try{const s=await(this.mode==="login"?Y.login:Y.register)(this.email,this.password);this.dispatchEvent(new CustomEvent(this.mode,{detail:s,bubbles:!0,composed:!0}))}catch(e){this.error=e.message??"An error occurred"}finally{this.loading=!1}}}render(){return r`
    ...
    `}};ot([u({type:Array})],G.prototype,"tenants",2);ot([u({type:Object})],G.prototype,"user",2);ot([l()],G.prototype,"showCreate",2);ot([l()],G.prototype,"newName",2);ot([l()],G.prototype,"creating",2);ot([l()],G.prototype,"error",2);G=ot([w("ccl-workspace-picker")],G);var os=Object.defineProperty,ls=Object.getOwnPropertyDescriptor,H=(t,e,s,a)=>{for(var i=a>1?void 0:a?ls(e,s):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(i=(a?o(e,s,i):o(i))||i);return a&&i&&os(e,s,i),i};let I=class extends g{constructor(){super(...arguments),this.tenantId="",this.items=[],this.loading=!0,this.error="",this.showModal=!1,this.editTarget=null,this.form={name:"",description:""},this.saving=!1}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.load()}async load(){this.loading=!0;try{this.items=await pt.list()}catch(t){this.error=t.message}finally{this.loading=!1}}openCreate(){this.editTarget=null,this.form={name:"",description:""},this.showModal=!0}openEdit(t){this.editTarget=t,this.form={name:t.name,description:t.description??""},this.showModal=!0}async save(t){t.preventDefault(),this.saving=!0;try{if(this.editTarget){const e=await pt.update(this.editTarget.id,this.form);this.items=this.items.map(s=>s.id===e.id?e:s)}else{const e=await pt.create(this.form);this.items=[e,...this.items]}this.showModal=!1}catch(e){this.error=e.message}finally{this.saving=!1}}async remove(t){if(confirm(`Delete project "${t.name}"? This cannot be undone.`))try{await pt.remove(t.id),this.items=this.items.filter(e=>e.id!==t.id)}catch(e){this.error=e.message}}statusBadge(t){return r`<span class="badge ${{active:"badge-green",completed:"badge-blue",archived:"badge-gray",on_hold:"badge-yellow"}[t]??"badge-gray"}">${t.replace("_"," ")}</span>`}render(){return r`
    ...
    `}};H([u()],I.prototype,"tenantId",2);H([l()],I.prototype,"items",2);H([l()],I.prototype,"loading",2);H([l()],I.prototype,"error",2);H([l()],I.prototype,"showModal",2);H([l()],I.prototype,"editTarget",2);H([l()],I.prototype,"form",2);H([l()],I.prototype,"saving",2);I=H([w("ccl-projects")],I);var ds=Object.defineProperty,cs=Object.getOwnPropertyDescriptor,y=(t,e,s,a)=>{for(var i=a>1?void 0:a?cs(e,s):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(i=(a?o(e,s,i):o(i))||i);return a&&i&&ds(e,s,i),i};const Tt=["todo","in_progress","in_review","done","blocked"],wt={todo:"To Do",in_progress:"In Progress",in_review:"In Review",done:"Done",blocked:"Blocked"},pe=["low","medium","high","critical"],hs={low:"badge-gray",medium:"badge-blue",high:"badge-yellow",critical:"badge-red"};let m=class extends g{constructor(){super(...arguments),this.tenantId="",this.items=[],this.projects=[],this.claws=[],this.loading=!0,this.error="",this.view="kanban",this.filterStatus="",this.filterProject="",this.filterPriority="",this.search="",this.showArchived=!1,this.showModal=!1,this.editTarget=null,this.form={},this.saving=!1,this.drawerTask=null,this.drawerExecutions=[],this.drawerTab="detail",this.running=!1,this.dragTaskId=""}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.load()}async load(){this.loading=!0;try{[this.items,this.projects,this.claws]=await Promise.all([P.list({archived:this.showArchived}),pt.list(),ut.list()])}catch(t){this.error=t.message}finally{this.loading=!1}}get filtered(){return this.items.filter(t=>!(this.filterStatus&&t.status!==this.filterStatus||this.filterProject&&t.projectId!==this.filterProject||this.filterPriority&&t.priority!==this.filterPriority||this.search&&!t.title.toLowerCase().includes(this.search.toLowerCase())))}tasksForStatus(t){return this.filtered.filter(e=>e.status===t)}openCreate(){this.editTarget=null,this.form={status:"todo",priority:"medium"},this.showModal=!0}openEdit(t,e){e?.stopPropagation(),this.editTarget=t,this.form={...t},this.showModal=!0}async save(t){t.preventDefault(),this.saving=!0;try{if(this.editTarget){const e=await P.update(this.editTarget.id,this.form);this.items=this.items.map(s=>s.id===e.id?e:s),this.drawerTask?.id===e.id&&(this.drawerTask=e)}else{const e=await P.create(this.form);this.items=[e,...this.items]}this.showModal=!1}catch(e){this.error=e.message}finally{this.saving=!1}}async remove(t,e){e.stopPropagation(),confirm(`Delete "${t.title}"?`)&&(await P.remove(t.id),this.items=this.items.filter(s=>s.id!==t.id),this.drawerTask?.id===t.id&&(this.drawerTask=null))}async patchStatus(t,e){const s=await P.update(t,{status:e});this.items=this.items.map(a=>a.id===t?s:a),this.drawerTask?.id===t&&(this.drawerTask=s)}async runTask(t,e){e.stopPropagation(),this.running=!0;try{const s=await P.run(t.id),a=await P.update(t.id,{status:"in_progress"});this.items=this.items.map(i=>i.id===a.id?a:i),this.drawerTask?.id===t.id&&(this.drawerTask=a,this.drawerExecutions=[s,...this.drawerExecutions])}catch(s){this.error=s.message}finally{this.running=!1}}async openDrawer(t){this.drawerTask=t,this.drawerTab="detail";try{this.drawerExecutions=await P.executions(t.id)}catch{this.drawerExecutions=[]}}closeDrawer(){this.drawerTask=null}dragStart(t){this.dragTaskId=t}dragOver(t){t.preventDefault()}async drop(t,e){t.preventDefault(),this.dragTaskId&&(await this.patchStatus(this.dragTaskId,e),this.dragTaskId="")}projectName(t){return t?this.projects.find(e=>e.id===t)?.name??t:"—"}clawName(t){return t?this.claws.find(e=>e.id===t)?.name??t:"Unassigned"}priorityBadge(t){return r`<span class="badge ${hs[t]}">${t}</span>`}statusBadge(t){return r`<span class="badge ${{todo:"badge-gray",in_progress:"badge-blue",in_review:"badge-yellow",done:"badge-green",blocked:"badge-red"}[t]}">${wt[t]}</span>`}formatDate(t){return t?new Date(t).toLocaleDateString(void 0,{month:"short",day:"numeric"}):""}render(){return r`
      <!-- Header -->
      <div class="page-header">
        <div>
      ...
      <div class="filters" style="margin-bottom:16px">
        ...
        <select class="select" style="max-width:160px;height:32px;padding:4px 10px"
          ...
          ${Tt.map(t=>r`<option value=${t}>${wt[t]}</option>`)}
        </select>
        <select class="select" style="max-width:160px;height:32px;padding:4px 10px"
        ...
        ${Tt.map(t=>r`
          <div class="kanban-col"
            ...
            <div class="kanban-col-header">
              <div class="kanban-col-title">${wt[t]}</div>
      ...
      <div style="overflow-x:auto">
        <div style="min-width:${o+200}px">
          ...
          <div style="position:relative">
            ...
            ${t.map(d=>{const b=new Date(d.createdAt),$=new Date(d.dueDate??d.createdAt),C=Math.floor((b.getTime()-s.getTime())/864e5),ct=Math.max(1,Math.ceil(($.getTime()-b.getTime())/864e5)),Ie={done:"var(--ok)",in_progress:"var(--accent)",blocked:"var(--danger)",in_review:"var(--warn)",todo:"var(--muted)"};return r`
      ...
      <div style="display:grid;gap:16px">
        ...
        <div class="card">
          ...
          <div style="display:flex;gap:6px;flex-wrap:wrap">
            ${Tt.filter(e=>e!==t.status).map(e=>r`
              <button class="btn btn-secondary btn-sm"
                @click=${()=>this.patchStatus(t.id,e)}>${wt[e]}</button>
            `)}
          </div>
        </div>
              ...
              <form @submit=${this.save} style="display:grid;gap:14px;margin-top:16px">
                ...
                <div class="field"><label class="label">Type</label>
                  <select class="select" @change=${t=>{this.form={...this.form,type:t.target.value}}}>
                    ${ys.map(t=>r`<option value=${t}>${t}</option>`)}
                  </select></div>
    ...
    `}};ft([u()],rt.prototype,"clawId",2);ft([u()],rt.prototype,"wsUrl",2);ft([l()],rt.prototype,"sessions",2);ft([l()],rt.prototype,"loading",2);ft([l()],rt.prototype,"error",2);rt=ft([w("ccl-claw-sessions")],rt);const _s="modulepreload",Cs=function(t,e){return new URL(t,e).href},me={},ye=function(e,s,a){let i=Promise.resolve();if(s&&s.length>0){let f=function(p){return Promise.all(p.map(d=>Promise.resolve(d).then(b=>({status:"fulfilled",value:b}),b=>({status:"rejected",reason:b}))))};const o=document.getElementsByTagName("link"),h=document.querySelector("meta[property=csp-nonce]"),c=h?.nonce||h?.getAttribute("nonce");i=f(s.map(p=>{if(p=Cs(p,a),p in me)return;me[p]=!0;const d=p.endsWith(".css"),b=d?'[rel="stylesheet"]':"";if(a)for(let C=o.length-1;C>=0;C--){const ct=o[C];if(ct.href===p&&(!d||ct.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${p}"]${b}`))return;const $=document.createElement("link");if($.rel=d?"stylesheet":_s,d||($.as="script"),$.crossOrigin="",$.href=p,c&&$.setAttribute("nonce",c),document.head.appendChild($),d)return new Promise((C,ct)=>{$.addEventListener("load",C),$.addEventListener("error",()=>ct(new Error(`Unable to preload CSS for ${p}`)))})}))}function n(o){const h=new Event("vite:preloadError",{cancelable:!0});if(h.payload=o,window.dispatchEvent(h),!h.defaultPrevented)throw o}return i.then(o=>{for(const h of o||[])h.status==="rejected"&&n(h.reason);return e().catch(n)})};var Ss=Object.defineProperty,As=Object.getOwnPropertyDescriptor,J=(t,e,s,a)=>{for(var i=a>1?void 0:a?As(e,s):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(i=(a?o(e,s,i):o(i))||i);return a&&i&&Ss(e,s,i),i};let M=class extends g{constructor(){super(...arguments),this.clawId="",this.wsUrl="",this.assigned=[],this.available=[],this.loading=!0,this.error="",this.showModal=!1,this.saving=!1}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.load()}updated(t){t.has("clawId")&&this.clawId&&this.load()}async load(){this.loading=!0;try{const[t,e]=await Promise.all([this.loadAssigned(),Xt.list().catch(()=>[])]);this.assigned=t,this.available=e}catch(t){this.error=t.message}finally{this.loading=!1}}async loadAssigned(){try{const{getTenantToken:t}=await ye(async()=>{const{getTenantToken:a}=await Promise.resolve().then(()=>he);return{getTenantToken:a}},void 0,import.meta.url),e=(typeof window<"u"&&window.API_URL)??"https://api.coderclaw.ai",s=await fetch(`${e}/api/skill-assignments/claws/${this.clawId}`,{headers:{Authorization:`Bearer ${t()??""}`}});return s.ok?s.json():[]}catch{return[]}}async assign(t){this.saving=!0;try{await vt.assignClaw(this.clawId,t),this.assigned=await this.loadAssigned(),this.showModal=!1}catch(e){this.error=e.message}finally{this.saving=!1}}async unassign(t){try{const{getTenantToken:e}=await ye(async()=>{const{getTenantToken:a}=await Promise.resolve().then(()=>he);return{getTenantToken:a}},void 0,import.meta.url),s=(typeof window<"u"&&window.API_URL)??"https://api.coderclaw.ai";await fetch(`${s}/api/skill-assignments/claws/${this.clawId}/${t}`,{method:"DELETE",headers:{Authorization:`Bearer ${e()??""}`}}),this.assigned=this.assigned.filter(a=>a.slug!==t)}catch(e){this.error=e.message}}assignedSlugs(){return new Set(this.assigned.map(t=>t.slug))}render(){const t=this.assignedSlugs(),e=this.available.filter(s=>!t.has(s.slug));return r`
      <div style="padding:16px;display:grid;gap:12px">
        <div style="display:flex;justify-content:space-between;align-items:center">
    ...
    `}};J([u()],M.prototype,"clawId",2);J([u()],M.prototype,"wsUrl",2);J([l()],M.prototype,"assigned",2);J([l()],M.prototype,"available",2);J([l()],M.prototype,"loading",2);J([l()],M.prototype,"error",2);J([l()],M.prototype,"showModal",2);J([l()],M.prototype,"saving",2);M=J([w("ccl-claw-skills")],M);var Ts=Object.defineProperty,Es=Object.getOwnPropertyDescriptor,lt=(t,e,s,a)=>{for(var i=a>1?void 0:a?Es(e,s):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(i=(a?o(e,s,i):o(i))||i);return a&&i&&Ts(e,s,i),i};let Z=class extends g{constructor(){super(...arguments),this.clawId="",this.wsUrl="",this.items=[],this.loading=!0,this.error="",this.timeFilter="week"}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.load()}updated(t){t.has("clawId")&&this.clawId&&this.load()}async load(){this.loading=!0;try{this.items=await Qt.list({clawId:this.clawId})}catch(t){this.error=t.message}finally{this.loading=!1}}filtered(){const t=Date.now(),s={today:864e5,week:6048e5,month:2592e6,all:1/0}[this.timeFilter];return this.items.filter(a=>t-new Date(a.createdAt).getTime()<s)}stats(t){const e=t.length,s=t.filter(n=>n.status==="completed").length,a=t.filter(n=>n.status==="failed").length,i=t.filter(n=>n.status==="running").length;return{total:e,completed:s,failed:a,running:i}}duration(t){if(!t.startedAt||!t.completedAt)return"—";const e=new Date(t.completedAt).getTime()-new Date(t.startedAt).getTime();return e<1e3?`${e}ms`:`${(e/1e3).toFixed(1)}s`}fmt(t){return new Date(t).toLocaleString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}render(){const t=this.filtered(),e=this.stats(t),s={completed:"badge-green",failed:"badge-red",running:"badge-blue",pending:"badge-gray",cancelled:"badge-gray"};return r`
      <div style="padding:16px;display:grid;gap:16px">
        <div style="display:flex;justify-content:space-between;align-items:center">
              ...
              <form @submit=${this.save} style="display:grid;gap:14px;margin-top:16px">
                <div class="field">
                  ...
                  <select class="select" @change=${e=>{this.selectedType=e.target.value,this.form={}}}>
                    ${zs.map(e=>r`<option value=${e}>${e}</option>`)}
                  </select>
                </div>
                ${t.map(e=>r`
                  <div class="field">
    ...
    `}};dt([u()],X.prototype,"clawId",2);dt([u()],X.prototype,"wsUrl",2);dt([l()],X.prototype,"lines",2);dt([l()],X.prototype,"level",2);dt([l()],X.prototype,"connState",2);dt([l()],X.prototype,"autoScroll",2);X=dt([w("ccl-claw-logs")],X);var Ks=Object.defineProperty,Ws=Object.getOwnPropertyDescriptor,_=(t,e,s,a)=>{for(var i=a>1?void 0:a?Ws(e,s):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(i=(a?o(e,s,i):o(i))||i);return a&&i&&Ks(e,s,i),i};const Js=[{id:"chat",label:"Chat"},{id:"agents",label:"Agents"},{id:"config",label:"Config"},{id:"sessions",label:"Sessions"},{id:"skills",label:"Skills"},{id:"usage",label:"Usage"},{id:"cron",label:"Cron"},{id:"nodes",label:"Nodes"},{id:"channels",label:"Channels"},{id:"logs",label:"Logs"}];let k=class extends g{constructor(){super(...arguments),this.tenantId="",this.clawList=[],this.loading=!1,this.error="",this.showRegisterModal=!1,this.registerName="",this.registering=!1,this.registerError="",this.newClaw=null,this.apiKeyCopied=!1,this.panelOpen=!1,this.activeClaw=null,this.activeTab="chat",this.deleteConfirmId=null,this.deleting=!1}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.loadClaws()}async loadClaws(){this.loading=!0,this.error="";try{this.clawList=await ut.list()}catch(t){this.error=t.message??"Failed to load claws"}finally{this.loading=!1}}openPanel(t){this.activeClaw=t,this.activeTab="chat",this.panelOpen=!0,document.body.style.overflow="hidden"}closePanel(){this.panelOpen=!1,document.body.style.overflow="",setTimeout(()=>{this.activeClaw=null},300)}async handleRegister(){if(this.registerName.trim()){this.registering=!0,this.registerError="";try{const t=await ut.register(this.registerName.trim());this.newClaw=t,this.clawList=[...this.clawList,t],this.registerName=""}catch(t){this.registerError=t.message??"Registration failed"}finally{this.registering=!1}}}closeRegisterModal(){this.showRegisterModal=!1,this.newClaw=null,this.registerName="",this.registerError="",this.apiKeyCopied=!1}async copyApiKey(){if(this.newClaw)try{await navigator.clipboard.writeText(this.newClaw.apiKey),this.apiKeyCopied=!0,setTimeout(()=>{this.apiKeyCopied=!1},2e3)}catch{}}async handleDelete(t){this.deleting=!0;try{await ut.remove(t),this.clawList=this.clawList.filter(e=>e.id!==t),this.deleteConfirmId=null,this.activeClaw?.id===t&&this.closePanel()}catch(e){this.error=e.message??"Delete failed"}finally{this.deleting=!1}}statusBadge(t){return t.status==="active"?r`<span class="badge badge-green">active</span>`:t.status==="suspended"?r`<span class="badge badge-red">suspended</span>`:r`<span class="badge badge-gray">${t.status}</span>`}connectedDot(t){const e=t.status==="active"&&t.connectedAt?"dot dot-green":"dot dot-gray";return r`<span class="${e}" title="${t.connectedAt?"connected":"offline"}"></span>`}renderRegisterModal(){return this.showRegisterModal?r`
    ...
    `}renderPanel(){if(!this.activeClaw)return r``;const t=this.activeClaw,e=ut.wsUrl(t.id);return r`
    ...
    `}render(){return r`
      ...
      ${this.renderPanel()}
    `}};_([u()],k.prototype,"tenantId",2);_([l()],k.prototype,"clawList",2);_([l()],k.prototype,"loading",2);_([l()],k.prototype,"error",2);_([l()],k.prototype,"showRegisterModal",2);_([l()],k.prototype,"registerName",2);_([l()],k.prototype,"registering",2);_([l()],k.prototype,"registerError",2);_([l()],k.prototype,"newClaw",2);_([l()],k.prototype,"apiKeyCopied",2);_([l()],k.prototype,"panelOpen",2);_([l()],k.prototype,"activeClaw",2);_([l()],k.prototype,"activeTab",2);_([l()],k.prototype,"deleteConfirmId",2);_([l()],k.prototype,"deleting",2);k=_([w("ccl-claws")],k);var Fs=Object.defineProperty,Vs=Object.getOwnPropertyDescriptor,Q=(t,e,s,a)=>{for(var i=a>1?void 0:a?Vs(e,s):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(i=(a?o(e,s,i):o(i))||i);return a&&i&&Fs(e,s,i),i};let B=class extends g{constructor(){super(...arguments),this.tenantId="",this.available=[],this.assigned=[],this.loading=!0,this.error="",this.search="",this.tab="assigned"}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.load()}async load(){this.loading=!0;try{const[t,e]=await Promise.all([Xt.list().catch(()=>[]),vt.listTenant().catch(()=>[])]);this.available=t,this.assigned=e}catch(t){this.error=t.message}finally{this.loading=!1}}async assign(t){try{await vt.assignTenant(t),this.assigned=await vt.listTenant()}catch(e){this.error=e.message}}async unassign(t){try{await vt.unassignTenant(t),this.assigned=this.assigned.filter(e=>e.slug!==t)}catch(e){this.error=e.message}}assignedSlugs(){return new Set(this.assigned.map(t=>t.slug))}filteredAvailable(){const t=this.search.toLowerCase();return this.available.filter(e=>!t||e.name.toLowerCase().includes(t)||(e.description??"").toLowerCase().includes(t))}render(){const t=this.assignedSlugs();return r`
      <div class="page-header">
        <div>
              ...
              <form @submit=${this.invite} style="display:grid;gap:14px;margin-top:16px">
                ...
                <div class="field"><label class="label">Role</label>
                  <select class="select" @change=${e=>{this.inviteRole=e.target.value}}>
                    ${Gs.filter(e=>e!=="owner").map(e=>r`<option value=${e}>${e}</option>`)}
                  </select></div>
                <div class="modal-footer">
    ...
    `}};U([u({type:Object})],T.prototype,"tenant",2);U([l()],T.prototype,"detail",2);U([l()],T.prototype,"loading",2);U([l()],T.prototype,"error",2);U([l()],T.prototype,"tab",2);U([l()],T.prototype,"showInvite",2);U([l()],T.prototype,"inviteEmail",2);U([l()],T.prototype,"inviteRole",2);U([l()],T.prototype,"inviting",2);T=U([w("ccl-workspace")],T);var Zs=Object.defineProperty,Xs=Object.getOwnPropertyDescriptor,V=(t,e,s,a)=>{for(var i=a>1?void 0:a?Xs(e,s):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(i=(a?o(e,s,i):o(i))||i);return a&&i&&Zs(e,s,i),i};let N=class extends g{constructor(){super(...arguments),this.tenantId="",this.items=[],this.tasks=[],this.loading=!0,this.error="",this.filterTask="",this.filterStatus="",this.expanded=null}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.load()}async load(){this.loading=!0;try{[this.items,this.tasks]=await Promise.all([Qt.list(),P.list().catch(()=>[])])}catch(t){this.error=t.message}finally{this.loading=!1}}filtered(){return this.items.filter(t=>!(this.filterTask&&t.taskId!==this.filterTask||this.filterStatus&&t.status!==this.filterStatus))}taskTitle(t){return this.tasks.find(e=>e.id===t)?.title??t}statusColor(t){return{completed:"badge-green",failed:"badge-red",running:"badge-blue",pending:"badge-gray",cancelled:"badge-gray"}[t]??"badge-gray"}duration(t){if(!t.startedAt||!t.completedAt)return"—";const e=new Date(t.completedAt).getTime()-new Date(t.startedAt).getTime();return e<1e3?`${e}ms`:`${(e/1e3).toFixed(1)}s`}fmt(t){return new Date(t).toLocaleString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}render(){const t=this.filtered();return r`
      <div class="page-header">
        <div>
    ...
    `}renderTabContent(){const t=this.tenant?.id??"";switch(this.tab){case"tasks":return r`<ccl-tasks .tenantId=${t}></ccl-tasks>`;case"projects":return r`<ccl-projects .tenantId=${t}></ccl-projects>`;case"claws":return r`<ccl-claws .tenantId=${t}></ccl-claws>`;case"skills":return r`<ccl-skills .tenantId=${t}></ccl-skills>`;case"workspace":return r`<ccl-workspace .tenant=${this.tenant}></ccl-workspace>`;case"logs":return r`<ccl-logs .tenantId=${t}></ccl-logs>`}}};R.styles=Oe``;tt([l()],R.prototype,"appState",2);tt([l()],R.prototype,"tab",2);tt([l()],R.prototype,"user",2);tt([l()],R.prototype,"tenantList",2);tt([l()],R.prototype,"tenant",2);tt([l()],R.prototype,"theme",2);tt([l()],R.prototype,"navCollapsed",2);R=tt([w("ccl-app")],R);
//# sourceMappingURL=index-xfnLQlPK.js.map
